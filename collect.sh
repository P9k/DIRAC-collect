...
rm -f distances.dat ar_br_scf.dat ar_br_ccsd.dat ar_bg_scf.dat ar_bg_ccsd.dat results.dat
...
rm distances.dat ar_br_scf.dat ar_br_ccsd.dat ar_bg_scf.dat ar_bg_ccsd.dat
